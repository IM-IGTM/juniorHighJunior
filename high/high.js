window.onload = function () {
  ...
  const korToEngPairs = [
    ...
    ["장벽, 장애물", "barrier"],
    ["일 년에 한번", "annually"],
    ["영감, 영감을 주는 것", "inspiration"],
    ["급증하다", "soar"],
    ["논쟁, 언쟁 / 논거, 주장", "argument"],
    ["혼란", "turmoil"],
    ["개별 지도 시간 / 사용 지침서", "tutorial"],
    ["적합한, 적절한", "suitable"],
    ["믿을 수 있는", "reliable"],
    ["우화", "parable"],
    ["의류, 의복", "apparel"],
